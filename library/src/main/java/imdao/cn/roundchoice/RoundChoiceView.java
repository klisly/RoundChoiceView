...
public class RoundChoiceView extends View {
    ...
    private int mCrossType = TYPE_CROSS_CROSS;
    ...
    private static final int TYPE_CROSS_NUMBER = 1;
    private static final int TYPE_CROSS_CROSS = 2;
    ...
    public void setmCrossType(int mCrossType) {
